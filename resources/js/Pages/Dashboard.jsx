          ...
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div className="p-6 text-gray-900 dark:text-gray-100">
              ...
              <p className="text-xl mt-4">
                <span className="mr-2">{myPendingTasks} Subjects</span>
              </p>
            </div>
          </div>
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div className="p-6 text-gray-900 dark:text-gray-100">
              ...
              <p className="text-xl mt-4">
                <span className="mr-2">{myProgressTasks} Subjects</span>
              </p>
            </div>
          </div>
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div className="p-6 text-gray-900 dark:text-gray-100">
              ...
              <p className="text-xl mt-4">
                <span className="mr-2">{myCompletedTasks} Subjects</span>
              </p>
            </div>
          </div>
        </div>
                      ...
                      <td className="px-3 py-2">
                        <span
                          className={
                            ...
                            PROJECT_STATUS_CLASS_MAP[subjects.status]
                          }
                        >
                          {PROJECT_STATUS_TEXT_MAP[subjects.status]}
                        </span>
                      </td>
                      <td className="px-3 py-2 text-nowrap">{subjects.units}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
